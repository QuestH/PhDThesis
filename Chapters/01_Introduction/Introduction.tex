...
\paragraph{Sub-Aims}
\begin{enumerate}
	\item To understand the influence of the EHL film on contact load and stiffness of rolling element bearings at the high speed, low torque operating conditions representative of electrified vehicle powertrains. 
	\item To assess the impact of implicit EHL modelling on the dynamic system response within an FMBD environment.
	...
	\item To determine whether ANN-based surrogate models can provide a viable embedded alternative to conventional film thickness formulations within dynamic simulations.
\end{enumerate}

\paragraph{Objectives}
\begin{enumerate}
	\item Design and implement a high-speed experimental test rig to measure bearing orbital motion as a kinematic input to tribological models. Use experimental results to establish suitable workflows for tribodynamic analysis and quantify the influence of EHL films on contact and component behaviour.
	...
	\item Integrate the lubricated bearing model into an FMBD environment to assess the influence of the EHL film on system-level dynamic response across a range of high‑speed operating conditions. 
	\item Design, train and validate an ANN capable of computing central EHL film thickness for a wide range of the required input parameters. Evaluate its feasibility for embedded use within FMBD simulation workflows.
\end{enumerate}

\paragraph{Tasks}
\begin{enumerate}
	\item Design, manufacture and commission a high-speed bearing test rig capable of operating up to the defined speed and load limits. Instrument the rig to measure bearing orbital motion and establish a repeatable data acquisition procedure suitable for use as kinematic boundary conditions in tribological analysis.
	\item Develop a lubricated component-level bearing model, including implicit representation of the EHL film at the roller–race contact.
	\item Integrate the lubricated bearing model into an FMBD environment to assess the influence of the EHL film on system-level dynamic response across a range of high‑speed operating conditions. 
	\item Design, train and validate an ANN capable of computing central EHL film thickness for a wide range of the required input parameters. Evaluate its feasibility for embedded use within FMBD simulation workflows.
\end{enumerate}
