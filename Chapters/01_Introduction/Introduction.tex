...
This style of powertrain architecture involves high-speed rolling element bearing operation. The motor and transmission input shaft bearings typically operate at rotational speeds up to 25~000~$rpm$, resulting in common $nDm$ speed factor values in the range of 0.5~-~1.2$~\times~10^6$~$mm/min$ and entrainment velocities as high as 30~$m \cdot \mathrm{s}^{-1}$.
