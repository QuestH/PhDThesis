...
Connections are created between bodies in the FMBD software using pins. Pins are assigned to specific nodes on the shaft and housing. The pins transmit a 6-element vector that describe the 6 DOFs (degrees of freedom) of the connection point. The first 3 elements translational degrees of freedom, whilst the latter represent rotational degrees of freedom. This are concatenated into a single communication vector that is then transferred to MATLAB\textregistered\.
