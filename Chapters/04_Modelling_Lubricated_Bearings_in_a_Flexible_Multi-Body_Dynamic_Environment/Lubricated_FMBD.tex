...
\subsection{Chapter Contributions to Knowledge}
Dynamic bearing models used in FMBD simulations typically represent rolling element bearings using simplified dry-contact stiffness formulations. The integration of lubricated bearing models within system-level dynamic simulations of electrified powertrains has not, to the author’s knowledge, been reported in the literature.
...
These results demonstrate that EHL film formation increases bearing stiffness and alters drivetrain dynamic response under high-speed electrified powertrain operation. Classical methods employed in dynamic models do not capture this behaviour due to modelling the contacts as dry. This improves these methods by providing a more accurate prediction of bearing orbital motion and total bearing stiffness.
