...
The displacement of the bearing centre, which governs the conditions at the contact, was determined experimentally using a high-speed bearing test rig\footnote[1]{The author was responsible for the design, technical drawings, partial manufacture, assembly and operation of the test rig.}. 
...
Radial force was transferred to the shaft via a hinge‑arm mechanism, terminating in a point‑load applicator. A point contact was selected to avoid the use of an auxiliary support bearing at the load application location. This would introduce additional excitation frequencies within the measurement bandwidth. The applied radial force was calibrated using a permanently preloaded force transducer (B\&K Type 8200), capable of measuring up to 5000~$N$ in compression.
