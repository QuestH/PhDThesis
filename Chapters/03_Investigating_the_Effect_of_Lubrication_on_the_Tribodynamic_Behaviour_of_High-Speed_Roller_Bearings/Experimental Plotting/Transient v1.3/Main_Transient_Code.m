...
global  X  a neta0 Lambda AK PH N alpha W1 Rrout

%% Input Parameters
l=0.009;%(m) Length of Contact
Rrout = 0.0045;%(m) Reduced radius outer race
neta0=0.08;% Dynamic Viscosity
E=1.159340659340659e+11;
u = 7.452; %7.452; % Surface velocity m/s
w = 2385; %2379; % Load N
...
W1=w/(l*E*Rrout); %dimensionless load
U=u*neta0/(Rrout*E); %dimensionless speed of entraining motion
alpha=2.2e-8; %pressure-viscosity constant
G=alpha*E;
a=Rrout*sqrt(8*W1/pi); %contact half width
PH=E*sqrt(W1/(2*pi)); %maximum Hertzian pressure?
Lambda=(12*E*U/PH)*(pi/(8*W1))^1.5; %dimensionless constant
...
Lambda=(12*E*U/PH)*(pi/(8*W1))^1.5; %Constant removed from none dimesnionalising?
...
F_Ph1=l*a*PH*F_Ph; %Dimensionalised force
